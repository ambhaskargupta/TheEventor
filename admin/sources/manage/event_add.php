    ...
    if (empty($_POST['venue'])) {
        ...
        if(isset($_FILES['file']['name']) AND !empty($_FILES['file']['name'])){
            ...
            if(in_array($exlower,$acceptex)){
                ...
                if($action != 'Update') {
                        $lastId = $function->fetch_data_single("SELECT MAX(id) FROM $venueTable",true);
...
<div class="container" style="width:auto;">
        ...
        ?>
        <div class="card">
            <div class="card-header"><h3><?php echo $formButton; ?> Event</h3></div>
            <div class="card-body">
                <div class="msg"></div>
...
<script>
    function addEdit() {
        ...
        $.ajax({
            type: "POST",
            cache: false,
            url: "ajax.php?sub=manage&page=event_add",
            contentType: false,
            processData:false,
            data: FrmEntry,
            beforeSend: function () {
