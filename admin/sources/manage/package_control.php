...
<script>
    ...
    function loadList() {
        ...
        $.ajax({
            type: "GET",
            cache: false,
            url: "ajax.php?sub=manage&page=package_list",
            data:formdata,
    ...
    function process(delid) {
        $.ajax({
            type: "GET",
            cache: false,
            url: "ajax.php?sub=manage&page=package_add&delid="+delid,
...
<section class="section">
          <div class="section-header">
            ...
            <div class="col-2">
                <a href="index.php?sub=manage&page=package_add" class="btn btn-info btn-sm"> Add Package</a>
            </div>
          </div>
